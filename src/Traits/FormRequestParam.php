...
trait FormRequestParam
{
    ...
    /**
     * @var array|FormRequestRulesParam[]
     */
    protected static array $formRequestRule = [];
    ...
    {
        if (isset(static::$formRequestRule[static::class])) {
            return static::$formRequestRule[static::class];
        }
        $rules        = [];
        $attributes   = [];
        $messages     = [];
        ...
        return static::$formRequestRule[static::class] = new FormRequestRulesParam(compact('rules', 'attributes', 'messages', 'fieldMapping'));
    }
